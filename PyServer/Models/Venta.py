...
class VentaBase(SQLModel):
    ...
    nom_comprador: str = Field(max_length=200, description="Nombre completo del comprador")
...
class VentaUpdate(BaseModel):
    ...
    nom_comprador: Optional[str] = Field(max_length=200, description="Nombre completo del comprador")
